...
our %config = (
  ...
  defines => [ "DSO_DLFCN", "HAVE_DLFCN_H", "NDEBUG", "OPENSSL_THREADS", "OPENSSL_NO_DYNAMIC_ENGINE", "OPENSSL_PIC", "OPENSSL_IA32_SSE2", "OPENSSL_BN_ASM_MONT", "OPENSSL_BN_ASM_MONT5", "OPENSSL_BN_ASM_GF2m", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "RC4_ASM", "MD5_ASM", "AES_ASM", "VPAES_ASM", "BSAES_ASM", "GHASH_ASM", "ECP_NISTZ256_ASM", "PADLOCK_ASM", "POLY1305_ASM" ],
  ...
  openssldir => "",
  options => "--prefix=/local/vahldiek/erim-public/src/nginx/../openssl/vmfunc/.openssl -Wa,--noexecstack no-aria no-asan no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-tls13downgrade no-tls1_3 no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl => "/usr/bin/perl",
  perlargv => [ "linux-x86_64", "--prefix=/local/vahldiek/erim-public/src/nginx/../openssl/vmfunc/.openssl", "no-shared", "-Wa,--noexecstack" ],
  prefix => "/local/vahldiek/erim-public/src/nginx/../openssl/vmfunc/.openssl",
  processor => "",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cc => "gcc",
  cflags => "-Wall -O3 -pthread -m64 -DL_ENDIAN",
  ...
  cxx => "g++",
  cxxflags => "-Wall -O3 -pthread -m64 -DL_ENDIAN",
  defines => [  ],
  ...
  enable => [  ],
  ex_libs => "-ldl ../../dune/libdune/libdune.a",
  exe_extension => "",
  ...
  shared_ldflag => "-Wl,-znodelete -m64",
  shared_rcflag => "",
