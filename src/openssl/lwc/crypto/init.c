...
# endif
    ...
    /*
     * MEMSEP print stats not needed directly in fini (see crypto/x86_64cpuid.pl)
     */
//	erim_print_stats(global_erm);
}
...
# endif
    ...
    /*
     * MEMSEP init refmon -> moved to crypto/x86_64cpuid.pl init section
     */
//    erm * mon = erim_createRefernceMonitor();
//    memsep_init(mon);
