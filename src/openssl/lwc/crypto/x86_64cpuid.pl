...
print<<___;
.extern erim_createRefernceMonitor
.extern memsep_init
.extern		OPENSSL_cpuid_setup
.hidden		OPENSSL_cpuid_setup
.section	.init
	call	OPENSSL_cpuid_setup
#init reference monitor before application start
   call erim_createRefernceMonitor
   mov    %rax,%rdi
   call memsep_init

.extern		erim_print_stats
.extern global_erm
.section	.fini
   movq   global_erm(%rip), %rdi
	call	erim_print_stats
