...
namespace llvm {
  ...
  public:
    ...
    /// getUnsafeStackPtrLocation - Return true if the target stores unsafe
    /// stack pointer at a fixed offset in some non-standard address
    /// space, and populates the address space and offset as
    /// appropriate.
    virtual bool getUnsafeStackPtrLocation(unsigned &AddressSpace, unsigned &Offset) const;
