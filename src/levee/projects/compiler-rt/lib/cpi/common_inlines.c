...
__CPI_INLINE
void __llvm__cpi_switch_trusted() {
  erim_switch_to_trusted;
  return;
}

__CPI_INLINE
void __llvm__cpi_switch_untrusted() {
...
__CPI_INLINE
void __llvm__cpi_switched_set(void **fptr, void *val) {
  __llvm__cpi_switched_set_bounds(fptr, val, __llvm__cpi_bounds_infty);
}
#else
__CPI_INLINE 
void __llvm__cpi_switched_set_bounds(void **fptr, void *val, __llvm__cpi_bounds bounds) {
  __llvm__cpi_switched_set(fptr, val);
}
#endif
