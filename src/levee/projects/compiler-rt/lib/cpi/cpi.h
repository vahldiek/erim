...
__CPI_EXPORT void __llvm__cpi_init(void); // ERIM

__CPI_INLINE void __llvm__cpi_set(void **fptr, void *val); //ERIM
__CPI_INLINE void __llvm__cpi_set_bounds(void **fptr, void *val,
                                         __llvm__cpi_bounds bounds); //ERIM

__CPI_INLINE void __llvm__cpi_switched_set(void **fptr, void *val); 
__CPI_INLINE void __llvm__cpi_switched_set_bounds(void **fptr, void *val,
                                         __llvm__cpi_bounds bounds); 

__CPI_INLINE __llvm__cpi_bounds __llvm__cpi_assert(void **fptr, void *val,
                                                   char *loc); // ERIM

__CPI_INLINE void *__llvm__cpi_get_metadata(void **fptr); //ERIM
__CPI_INLINE void *__llvm__cpi_get_metadata_nocheck(void **fptr); //ERIM
__CPI_INLINE void *__llvm__cpi_get_val(void *metadata);//ERIM
__CPI_INLINE __llvm__cpi_bounds __llvm__cpi_get_bounds(void *metadata);//ERIM

__CPI_EXPORT void __llvm__cpi_dump(void **fptr); // ERIM

__CPI_EXPORT void __llvm__cpi_delete_range(unsigned char *fptr, size_t size); // ERIM

__CPI_EXPORT void __llvm__cpi_copy_range(unsigned char *fptr_dst,
                                         unsigned char *fptr, size_t size); // ERIM
__CPI_EXPORT void __llvm__cpi_move_range(unsigned char *fptr_dst,
                                         unsigned char *fptr, size_t size); // ERIM

// Common functions (implementation independent)

__CPI_INLINE void __llvm__cpi_switch_refmon();
__CPI_INLINE void __llvm__cpi_switch_application();

__CPI_INLINE void __llvm__cpi_assert_bounds(void *val, size_t size,
                                            __llvm__cpi_bounds bounds,
                                            char *loc); //empty

__CPI_INLINE unsigned long __llvm__cpi_malloc_size(unsigned char *fptr);  // malloc based

__CPI_INLINE void __llvm__cpi_alloc(unsigned char *fptr); // llvm__cpi_delete_range

__CPI_EXPORT void __llvm__cpi_realloc(unsigned char *fptr_new,
                                      unsigned long size_new,
                                      unsigned char *fptr_old,
                                      unsigned long size_old); // __llvm__cpi_move_range

__CPI_INLINE void __llvm__cpi_free(unsigned char *fptr); // __llvm_cpi_free

__CPI_INLINE void __llvm__cpi_set_arg_bounds(uint32_t arg_no,
                                             __llvm__cpi_bounds bounds); // not used
__CPI_INLINE __llvm__cpi_bounds __llvm__cpi_get_arg_bounds(uint32_t arg_no); // not used
