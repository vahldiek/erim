...
public:
  ...
  void setHaveSafeStackFunctions() { HaveSafeStackFunctions = true; }
...
private:
  ...
  /// EmitSafeStackGlobals - Emit external globals required by safestack functions
  void EmitSafeStackGlobals();
