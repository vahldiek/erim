...
o  systems.  It cannot be size_t, because it supports negative
...
#define sh_memalign             memalign
#define sh_posix_memalign       posix_memalign
#define sh_realloc              realloc
#define sh_realloc_in_place     realloc_in_place
#define sh_valloc               valloc
#define sh_pvalloc              pvalloc
#define sh_mallinfo             mallinfo
#define sh_mallopt              mallopt
#define sh_malloc_trim          malloc_trim
#define sh_malloc_stats         malloc_stats
#define sh_malloc_usable_size   malloc_usable_size
#define sh_malloc_footprint     malloc_footprint
#define sh_malloc_max_footprint malloc_max_footprint
#define sh_malloc_footprint_limit malloc_footprint_limit
#define sh_malloc_set_footprint_limit malloc_set_footprint_limit
#define sh_malloc_inspect_all   malloc_inspect_all
#define sh_independent_calloc   independent_calloc
#define sh_independent_comalloc independent_comalloc
...
*/
DLMALLOC_EXPORT void sh_malloc_inspect_all(void(*handler)(void*, void *, size_t, void*),
                           void* arg);
...
*/
size_t sh_malloc_usable_size(void*);
