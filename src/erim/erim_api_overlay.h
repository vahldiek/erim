...
#ifndef _ERIM_API_OVERLAY_H_
#define _ERIM_API_OVERLAY_H_
...
/* Overlay API works in combination with inlined
 * API. To start init erim with erim_init.
 * Use ERIM_BRIDGE to define functions which
 * switch into and out of the reference monitor.
 * Call ERIM_BRIDGE_CALL to execute code in 
 * refmon instead of directly.
 */
...
#define ERIM_DEFINE_BRIDGEARGS8(ret, f, type1, arg1, type2, arg2, type3, arg3, type4, arg4, type5, arg5, type6, arg6, type7, arg7, type8, arg8) \
  ...
  #define ERIM_SWITCH_IN erim_switch_to_trusted
  #define ERIM_SWITCH_OUT erim_switch_to_untrusted
#else
  #define ERIM_SWITCH_IN erim_switch_to_untrusted
  #define ERIM_SWITCH_OUT erim_switch_to_trusted
#endif
